...
mod tests {
    ...
    fn simple_iterator() {
        ...
        assert_eq!(Some(Rc::new(1)), integers_cached_iter.next());
        assert_eq!(Some(Rc::new(2)), integers_cached_iter.next());
        assert_eq!(Some(Rc::new(3)), integers_cached_iter.next());
        assert_eq!(Some(Rc::new(4)), integers_cached_iter.next());
